...
export const narrationJobs = sqliteTable('narration_jobs', {
  id: integer('id').primaryKey({ autoIncrement: true }),
  title: text('title').notNull(),
...
export const narrationSegments = sqliteTable('narration_segments', {
  ...
  ttsDurationSec: real('tts_duration_sec'),
...
export const subtitleRemovalJobs = sqliteTable('subtitle_removal_jobs', {
  id: integer('id').primaryKey({ autoIncrement: true }),
  title: text('title').notNull(),
  userId: integer('user_id').notNull(),
  teamId: integer('team_id'),
  ...
  inpaintMode: text('inpaint_mode').default('sttn-auto'),
  subtitleAreasJson: text('subtitle_areas_json'),
...
export const ttsGenerations = sqliteTable('tts_generations', {
  id: integer('id').primaryKey({ autoIncrement: true }),
  userId: integer('user_id').notNull(),
  teamId: integer('team_id'),
  dramaId: integer('drama_id'),
  text: text('text').notNull(),
  voiceAssetId: integer('voice_asset_id'),
  voicePath: text('voice_path'),
  voicePresetId: text('voice_preset_id'),
  voiceName: text('voice_name'),
  emotionMode: text('emotion_mode').default('same'),
...
export const canvasBoards = sqliteTable('canvas_boards', {
  id: integer('id').primaryKey({ autoIncrement: true }),
  dramaId: integer('drama_id').notNull().unique(),
  title: text('title').notNull(),
  teamId: integer('team_id'),
  createdBy: integer('created_by').notNull(),
  focusEpisodeId: integer('focus_episode_id'),
